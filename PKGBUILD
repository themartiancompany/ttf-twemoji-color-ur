...
source=(
  "${url}/releases/download/v${pkgver}/TwitterColorEmoji-SVGinOT-Linux-${pkgver}.tar.gz"
)
b2sums=(
  'c9b36fd314cbfc163fcd585d8fc2535fc2dc3a86cbf67af14223243baabe8ecb66a3600afcb0d274482eb18f69983e8f011b689afc3926799a2c429395599224'
)

package() {
  cd \
    TwitterColorEmoji-SVGinOT-Linux-${pkgver}
  install \
    -Dm644 \
    TwitterColorEmoji-SVGinOT.ttf \
    -t \
    "$pkgdir"/usr/share/fonts/twemoji-color-font/
  install \
    -Dm644 \
    LICENSE* \
    -t \
  ...
  install \
    ...
    "$pkgdir"/usr/share/fontconfig/conf.avail/46-$pkgname.conf
}
